...
/obj/item/reagent_containers/food/snacks/candy/jellybean/someflavor
	...
	New()
		...
		SPAWN(0)
			...
			// set up flavors
			if(prob(50))
				flavor = pick("cardboard", "human souls", "something unspeakable", "egg", "vomit", "snot", "earwax", "wet dog", "belly-button lint", "sweat", "congealed farts", "mold", "armpits", "elbow grease", "sour milk", "WD-40", "slime", "blob", "gym sock", "pants", "brussels sprouts", "feet", "litter box", "durian fruit", "asbestos", "corpse flower", "corpse", "cow dung", "rot", "tar", "ham")
	...
	New()
		...
		SPAWN(0)
			if (src.reagents)
				...
				if(prob(50))
					flavor = pick("egg", "vomit", "snot", "earwax", "wet dog", "belly-button lint", "sweat", "congealed farts", "mold", "armpits", "elbow grease", "sour milk", "WD-40", "slime", "blob", "gym sock", "pants", "brussels sprouts", "feet", "litter box", "durian fruit", "asbestos", "corpse flower", "corpse", "cow dung", "rot", "tar", "ham", "gooncode", "quark-gluon plasma", "bee", "heat death")
					phrase = pick("Oh god", "Jeez", "Ugh", "Blecch", "Holy crap that's awful", "What the hell?", "*HURP*", "Phoo")
					tastesbad = 1
				else
