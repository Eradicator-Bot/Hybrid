...
/obj/item/reagent_containers/food/snacks/donut
	...
	heal(var/mob/M)
		if(ishuman(M) && (M.job in list("Security Officer", "Officer Paramedic", "Head of Security", "Detective", "Nanotrasen Security Consultant", "Security Assistant", "Part-time Vice Officer")))
			src.heal_amt *= 2
			..()
			src.heal_amt /= 2
		else
