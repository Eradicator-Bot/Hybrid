...
/datum/intercept_text/proc/build_rev(correct_mob)
	...
	if(prob(prob_right_job))
		...
		job_tmp.Remove("Captain", "Security Officer", "Officer Paramedic", "Security Assistant", "Vice Officer", "Detective", "Head Of Security", "Head of Personnel", "Chief Engineer", "Research Director")
