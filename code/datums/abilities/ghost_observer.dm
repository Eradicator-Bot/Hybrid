	...
	MouseEntered(location, control, params)
		if (usr.client.tooltipHolder && control == "mapwindow.map")
			...
			usr.client.tooltipHolder.showHover(src, list(
				...
				"content" = "[spooktober_GH.points] Points <br>All Points are shared between ghosts. <br>Spinning chairs, flipping, and using the ouija board as a ghost generates more points faster.",//(src.desc ? src.desc : null),
				"theme" = theme
			))
